 ...
 */
public class UIMenuActivity extends ToolbarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initializeActivity(R.string.title_activity_ui_menu, true, R.layout.activity_menu);
