 ...
 */
public class InputEditTextActivity extends ToolbarActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initializeActivity(R.string.title_activity_input_edit_text, true, R.layout.activity_input_edit_text);
