package com.github.jiahuanyu.example.layoutinflater;
 ...
 */
public class SetFactoryActivity extends BaseActivity
{
    private static final String TAG = "SetFactoryActivity";
