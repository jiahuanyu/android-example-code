...
You can find the ID of your me.jiahuan.androidlearn.App by searching the registry for the appID you specified at installation of your app. For example if you are using the squirrel framework your appID will be something like com.squirrel.your.app.
...
notifier.notify(
  {
    ...
    appID: void 0, // String. me.jiahuan.androidlearn.App.ID and app Name. Defaults to no value, causing SnoreToast text to be visible.
